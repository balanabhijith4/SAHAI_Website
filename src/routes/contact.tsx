        ...
        <Reveal>
          ...
          >
            ...
            <FloatingField label="Subject">
              <select className="w-full rounded-xl bg-canvas ring-1 ring-border px-4 py-3 text-sm focus:outline-none focus:ring-ink transition-all">
            ...
            <FloatingField label="Message">
              <textarea rows={6} placeholder="Tell us briefly about your interest..." className="w-full rounded-xl bg-canvas ring-1 ring-border px-4 py-3 text-sm focus:outline-none focus:ring-ink focus:ring-2 resize-none transition-all" />
            </FloatingField>
            <motion.button
              ...
              type="button"
              className="inline-flex items-center gap-2 rounded-full bg-ink text-canvas px-6 py-3 text-sm font-medium"
            >
              Send message →
            </motion.button>
          </motion.form>
              ...
              <div key={i}>
                ...
                <AnimatePresence initial={false}>
                  {open === i && (
                    ...
                    >
                      <p className="px-6 lg:px-8 pb-6 lg:pb-8 text-sm text-ink-soft leading-relaxed">{f.a}</p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
